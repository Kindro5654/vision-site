...
export const CLUB_EVENTS: ClubEvent[] = [
  { num: '01', tag: 'Главное', title: 'Большая встреча VISION CLUB', desc: 'Главное событие месяца, где мы подводим итоги, делимся результатами, инсайтами и кейсами резидентов.', src: '/assets/events/big-meeting.webp', objPos: 'center 40%', recurrence: 'monthly' },
  ...
  { num: '04', tag: 'Актив', title: 'Неформальные встречи', desc: 'Гольф, яхты, хайкинг, мафия, выезды с семьями — и многие другие!', src: '/assets/events/informal.webp', objPos: 'center 30%', recurrence: 'monthly' },
  ...
  { num: '06', tag: 'Тревел', title: 'Путешествия клуба', desc: 'Совместные поездки по миру: новые страны, приключения и нетворкинг за пределами Дубая.', src: '/assets/events/travel.webp', objPos: 'center 50%', recurrence: 'quarterly' },
  { num: '07', tag: 'Кино', title: 'Синемалогия', desc: 'Совместный просмотр и глубокий разбор фильмов — о людях, бизнесе и решениях.', src: '/assets/events/cinema.webp', objPos: 'center 40%', recurrence: 'monthly' },
