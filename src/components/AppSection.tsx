    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="vc-pb" style={{ position: 'absolute', right: 26, top: 60, zIndex: 1, transform: 'rotate(6deg)' }}>
          ...
          <div className="vc-pa" style={{ position: 'absolute', left: 34, bottom: 46, zIndex: 2, transform: 'rotate(-7deg)' }}>
