...
const RESIDENTS = [
  { role: 'Основательница медицинских проектов в ОАЭ', name: 'Ксения Бутова', brands: 'Detki & Family Clinics, Molodost’, Olempic, VOLNA', desc: 'Запустила сеть клиник и мед-проектов в Дубае и регионе MENA.', src: '/assets/people/res-butova.jpg', objPos: 'center 22%' },
  ...
  { role: 'Property Management', name: 'Алексей Щевлягин', brands: 'Stonetree — Property Management', desc: 'Управляет крупнейшим портфелем недвижимости в Дубае — более 450 объектов.', src: '/assets/people/res-shevlyagin.jpg', objPos: 'center 22%' },
  ...
  { role: 'Юридический бизнес, инвестиции, ресторан Manul', name: 'Ольга Нойбергер', brands: 'Юрфирма, инвестиции, ресторан Manul', desc: 'Управляет юрфирмой и стартапами, владелица ресторана — топ-30/100 России.', src: '/assets/people/res-neuberger.jpg', objPos: 'center 22%' },
  ...
  { role: 'BSI Lifestyle, Banya Forrest Dubai', name: 'Артём Аванесов', brands: 'BSI Lifestyle, Banya Forrest Dubai', desc: 'Руководит сетью из 7 офисов BSI и премиальной баней Forrest в Дубае.', src: '/assets/people/res-avanesov.jpg', objPos: 'center 22%' },
