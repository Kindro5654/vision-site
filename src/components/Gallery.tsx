...
const TILES: Tile[] = [
  ...
  { src: '/assets/gallery/nr2.png', pos: 'center 35%', gridColumn: '3/4', gridRow: '1/3' },
  ...
  { src: '/assets/gallery/nr0.png', pos: 'center 42%', gridColumn: '2/4', gridRow: '3/4' },
  ...
  { src: '/assets/gallery/nr1.png', pos: 'center 45%', gridColumn: '1/3', gridRow: '6/7' },
